...
def myFunction(event=None):
    ...
    if s100.get() == "" or s100.get()[0] not in (cevablar):
        ...
        if s100.get()[0] in answers[99]:
            ...
            tr100['fg']="red"
            Yanlis+=1
    if s101.get() == "" or s101.get()[0] not in (cevablar):
        tr101['text']=""
        Bos+=1
    else:
        if s101.get()[0] in answers[100]:
            tr101['text']="✔️"
            tr101['fg']="green"
            Dogru+=1
        else:
            ...
            tr101['fg']="red"
            Yanlis+=1
    if s102.get() == "" or s102.get()[0] not in (cevablar):
        tr102['text']=""
        Bos+=1
    else:
        if s102.get()[0] in answers[101]:
            tr102['text']="✔️"
            tr102['fg']="green"
            Dogru+=1
        else:
            ...
            tr102['fg']="red"
            Yanlis+=1
    if s103.get() == "" or s103.get()[0] not in (cevablar):
        tr103['text']=""
        Bos+=1
    else:
        if s103.get()[0] in answers[102]:
            tr103['text']="✔️"
            tr103['fg']="green"
            Dogru+=1
        else:
            ...
            tr103['fg']="red"
            Yanlis+=1
    if s104.get() == "" or s104.get()[0] not in (cevablar):
        tr104['text']=""
        Bos+=1
    else:
        if s104.get()[0] in answers[103]:
            tr104['text']="✔️"
            tr104['fg']="green"
            Dogru+=1
        else:
            ...
            tr104['fg']="red"
            Yanlis+=1
    if s105.get() == "" or s105.get()[0] not in (cevablar):
        tr105['text']=""
        Bos+=1
    else:
        if s105.get()[0] in answers[104]:
            tr105['text']="✔️"
            tr105['fg']="green"
            Dogru+=1
        else:
            ...
            tr105['fg']="red"
            Yanlis+=1
    if s106.get() == "" or s106.get()[0] not in (cevablar):
        tr106['text']=""
        Bos+=1
    else:
        if s106.get()[0] in answers[105]:
            tr106['text']="✔️"
            tr106['fg']="green"
            Dogru+=1
        else:
            ...
            tr106['fg']="red"
            Yanlis+=1
    if s107.get() == "" or s107.get()[0] not in (cevablar):
        tr107['text']=""
        Bos+=1
    else:
        if s107.get()[0] in answers[106]:
            tr107['text']="✔️"
            tr107['fg']="green"
            Dogru+=1
        else:
            ...
            tr107['fg']="red"
            Yanlis+=1
    if s108.get() == "" or s108.get()[0] not in (cevablar):
        tr108['text']=""
        Bos+=1
    else:
        if s108.get()[0] in answers[107]:
            tr108['text']="✔️"
            tr108['fg']="green"
            Dogru+=1
        else:
            ...
            tr108['fg']="red"
            Yanlis+=1
    if s109.get() == "" or s109.get()[0] not in (cevablar):
        tr109['text']=""
        Bos+=1
    else:
        if s109.get()[0] in answers[108]:
            tr109['text']="✔️"
            tr109['fg']="green"
            Dogru+=1
        else:
            ...
            tr109['fg']="red"
            Yanlis+=1
    if s110.get() == "" or s110.get()[0] not in (cevablar):
        tr110['text']=""
        Bos+=1
    else:
        if s110.get()[0] in answers[109]:
            tr110['text']="✔️"
            tr110['fg']="green"
            Dogru+=1
        else:
            ...
            tr110['fg']="red"
            Yanlis+=1
    if s111.get() == "" or s111.get()[0] not in (cevablar):
        tr111['text']=""
        Bos+=1
    else:
        if s111.get()[0] in answers[110]:
            tr111['text']="✔️"
            tr111['fg']="green"
            Dogru+=1
        else:
            ...
            tr111['fg']="red"
            Yanlis+=1
    if s112.get() == "" or s112.get()[0] not in (cevablar):
        tr112['text']=""
        Bos+=1
    else:
        if s112.get()[0] in answers[111]:
            tr112['text']="✔️"
            tr112['fg']="green"
            Dogru+=1
        else:
            ...
            tr112['fg']="red"
            Yanlis+=1
    if s113.get() == "" or s113.get()[0] not in (cevablar):
        tr113['text']=""
        Bos+=1
    else:
        if s113.get()[0] in answers[112]:
            tr113['text']="✔️"
            tr113['fg']="green"
            Dogru+=1
        else:
            ...
            tr113['fg']="red"
            Yanlis+=1
    if s114.get() == "" or s114.get()[0] not in (cevablar):
        tr114['text']=""
        Bos+=1
    else:
        if s114.get()[0] in answers[113]:
            tr114['text']="✔️"
            tr114['fg']="green"
            Dogru+=1
        else:
            ...
            tr114['fg']="red"
            Yanlis+=1
    if s115.get() == "" or s115.get()[0] not in (cevablar):
        tr115['text']=""
        Bos+=1
    else:
        if s115.get()[0] in answers[114]:
            tr115['text']="✔️"
            tr115['fg']="green"
            Dogru+=1
        else:
            ...
            tr115['fg']="red"
            Yanlis+=1
    if s116.get() == "" or s116.get()[0] not in (cevablar):
        tr116['text']=""
        Bos+=1
    else:
        if s116.get()[0] in answers[115]:
            tr116['text']="✔️"
            tr116['fg']="green"
            Dogru+=1
        else:
            ...
            tr116['fg']="red"
            Yanlis+=1
    if s117.get() == "" or s117.get()[0] not in (cevablar):
        tr117['text']=""
        Bos+=1
    else:
        if s117.get()[0] in answers[116]:
            tr117['text']="✔️"
            tr117['fg']="green"
            Dogru+=1
        else:
            ...
            tr117['fg']="red"
            Yanlis+=1
    if s118.get() == "" or s118.get()[0] not in (cevablar):
        tr118['text']=""
        Bos+=1
    else:
        if s118.get()[0] in answers[117]:
            tr118['text']="✔️"
            tr118['fg']="green"
            Dogru+=1
        else:
            ...
            tr118['fg']="red"
            Yanlis+=1
    if s119.get() == "" or s119.get()[0] not in (cevablar):
        tr119['text']=""
        Bos+=1
    else:
        if s119.get()[0] in answers[118]:
            tr119['text']="✔️"
            tr119['fg']="green"
            Dogru+=1
        else:
            ...
            tr119['fg']="red"
            Yanlis+=1
    if s120.get() == "" or s120.get()[0] not in (cevablar):
        tr120['text']=""
        Bos+=1
    else:
        if s120.get()[0] in answers[119]:
            tr120['text']="✔️"
            tr120['fg']="green"
            Dogru+=1
        else:
...
tr101 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr101.place(x=150,y=5020)
tr102 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr102.place(x=150,y=5070)
tr103 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr103.place(x=150,y=5120)
tr104 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr104.place(x=150,y=5170)
tr105 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr105.place(x=150,y=5220)
tr106 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr106.place(x=150,y=5270)
tr107 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr107.place(x=150,y=5320)
tr108 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr108.place(x=150,y=5370)
tr109 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr109.place(x=150,y=5420)
tr110 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr110.place(x=150,y=5470)
tr111 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr111.place(x=150,y=5520)
tr112 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr112.place(x=150,y=5570)
tr113 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr113.place(x=150,y=5620)
tr114 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr114.place(x=150,y=5670)
tr115 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr115.place(x=150,y=5720)
tr116 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr116.place(x=150,y=5770)
tr117 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr117.place(x=150,y=5820)
tr118 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr118.place(x=150,y=5870)
tr119 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr119.place(x=150,y=5920)
tr120 = Label(second_frame,text="",fg='green',font=("Roboto",25))
tr120.place(x=150,y=5970)
...
Label(second_frame,text=101,font=("Roboto",25)).place(x=20,y=5020)
s101=Entry(second_frame,width=2,font=('Arial 24'))
s101.place(x=100,y=5020)
second_frame.configure(height=5353)
Label(second_frame,text=102,font=("Roboto",25)).place(x=20,y=5070)
s102=Entry(second_frame,width=2,font=('Arial 24'))
s102.place(x=100,y=5070)
second_frame.configure(height=5406)
Label(second_frame,text=103,font=("Roboto",25)).place(x=20,y=5120)
s103=Entry(second_frame,width=2,font=('Arial 24'))
s103.place(x=100,y=5120)
second_frame.configure(height=5459)
Label(second_frame,text=104,font=("Roboto",25)).place(x=20,y=5170)
s104=Entry(second_frame,width=2,font=('Arial 24'))
s104.place(x=100,y=5170)
second_frame.configure(height=5512)
Label(second_frame,text=105,font=("Roboto",25)).place(x=20,y=5220)
s105=Entry(second_frame,width=2,font=('Arial 24'))
s105.place(x=100,y=5220)
second_frame.configure(height=5565)
Label(second_frame,text=106,font=("Roboto",25)).place(x=20,y=5270)
s106=Entry(second_frame,width=2,font=('Arial 24'))
s106.place(x=100,y=5270)
second_frame.configure(height=5618)
Label(second_frame,text=107,font=("Roboto",25)).place(x=20,y=5320)
s107=Entry(second_frame,width=2,font=('Arial 24'))
s107.place(x=100,y=5320)
second_frame.configure(height=5671)
Label(second_frame,text=108,font=("Roboto",25)).place(x=20,y=5370)
s108=Entry(second_frame,width=2,font=('Arial 24'))
s108.place(x=100,y=5370)
second_frame.configure(height=5724)
Label(second_frame,text=109,font=("Roboto",25)).place(x=20,y=5420)
s109=Entry(second_frame,width=2,font=('Arial 24'))
s109.place(x=100,y=5420)
second_frame.configure(height=5777)
Label(second_frame,text=110,font=("Roboto",25)).place(x=20,y=5470)
s110=Entry(second_frame,width=2,font=('Arial 24'))
s110.place(x=100,y=5470)
second_frame.configure(height=5830)
Label(second_frame,text=111,font=("Roboto",25)).place(x=20,y=5520)
s111=Entry(second_frame,width=2,font=('Arial 24'))
s111.place(x=100,y=5520)
second_frame.configure(height=5883)
Label(second_frame,text=112,font=("Roboto",25)).place(x=20,y=5570)
s112=Entry(second_frame,width=2,font=('Arial 24'))
s112.place(x=100,y=5570)
second_frame.configure(height=5936)
Label(second_frame,text=113,font=("Roboto",25)).place(x=20,y=5620)
s113=Entry(second_frame,width=2,font=('Arial 24'))
s113.place(x=100,y=5620)
second_frame.configure(height=5989)
Label(second_frame,text=114,font=("Roboto",25)).place(x=20,y=5670)
s114=Entry(second_frame,width=2,font=('Arial 24'))
s114.place(x=100,y=5670)
second_frame.configure(height=6042)
Label(second_frame,text=115,font=("Roboto",25)).place(x=20,y=5720)
s115=Entry(second_frame,width=2,font=('Arial 24'))
s115.place(x=100,y=5720)
second_frame.configure(height=6095)
Label(second_frame,text=116,font=("Roboto",25)).place(x=20,y=5770)
s116=Entry(second_frame,width=2,font=('Arial 24'))
s116.place(x=100,y=5770)
second_frame.configure(height=6148)
Label(second_frame,text=117,font=("Roboto",25)).place(x=20,y=5820)
s117=Entry(second_frame,width=2,font=('Arial 24'))
s117.place(x=100,y=5820)
second_frame.configure(height=6201)
Label(second_frame,text=118,font=("Roboto",25)).place(x=20,y=5870)
s118=Entry(second_frame,width=2,font=('Arial 24'))
s118.place(x=100,y=5870)
second_frame.configure(height=6254)
Label(second_frame,text=119,font=("Roboto",25)).place(x=20,y=5920)
s119=Entry(second_frame,width=2,font=('Arial 24'))
s119.place(x=100,y=5920)
second_frame.configure(height=6307)
Label(second_frame,text=120,font=("Roboto",25)).place(x=20,y=5970)
s120=Entry(second_frame,width=2,font=('Arial 24'))
s120.place(x=100,y=5970)
second_frame.configure(height=6360)
